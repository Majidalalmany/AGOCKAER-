      ...
      <div className="bg-gradient-to-l from-slate-900 via-slate-800 to-blue-950 p-6 rounded-2xl shadow-md text-white flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        {onOpenAbsherSupport && (
          <button
            ...
            className="bg-emerald-500 hover:bg-emerald-600 text-slate-950 font-extrabold text-xs px-4 py-3 rounded-xl shadow-lg flex items-center justify-center gap-2 transition-all shrink-0 active:scale-98"
          >
            <Sparkles className="w-4 h-4 fill-current" />
            <span>طلب تعديلات أو إبلاغ عن مشكلة (أبشر)</span>
          </button>
        )}
      </div>
